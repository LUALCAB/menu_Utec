...
class Ui_PrimeraWindow(object):
    def setupUi(self, PrimeraWindow):
        ...
        self.lblLogo.setPixmap(QtGui.QPixmap(_fromUtf8("../../.designer/backup/UTEC.png")))
